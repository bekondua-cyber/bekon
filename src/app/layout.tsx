...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "id_ID",
    type: "website",
    images: [{ url: "https://res.cloudinary.com/dfkmge5kg/image/upload/v1783043593/ogimage_dvjkh3.png", width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["https://res.cloudinary.com/dfkmge5kg/image/upload/v1783043593/ogimage_dvjkh3.png"],
  },
  robots: {
    index: true,
    follow: true,
